          ...
          numChannels (numChannels_)
{
    ...
    setResamplingRatio(samplesInPerOutputSample);
}
...
void ResamplingPositionableAudioSource::getNextAudioBlock (const AudioSourceChannelInfo& info)
{
    double localRatio;
    ...
    for (int channel = 0; channel < channelsToProcess; ++channel)
    {
        ...
        srcBuffers[channel] = buffer.getWritePointer (channel, 0);
    }
...
void ResamplingPositionableAudioSource::setFilterCoefficients (double c1, double c2, double c3, double c4, double c5, double c6)
{
