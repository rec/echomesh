...
class TestColorSpread(TestCase):
  ...
  def test_two_colors_identity(self):
    self.result = [
      ...
      [ 0. ,  1. ,  0.6],
      [ 0. ,  1. ,  1. ]]
    self.assertSpreadResult([1, 1, 0], [0, 1, 1], 6, Transform.IDENTITY)
  ...
  def test_two_colors_square(self):
    self.result = [
      ...
      [ 0.        ,  1.        ,  0.7202941 ],
      [ 0.        ,  1.        ,  1.        ]]
    self.assertSpreadResult([1, 1, 0], [0, 1, 1], 6, transform=Transform.SQUARE)

  def test_two_colors_power_2(self):
    self.result = [
      [ 1.        ,  1.        ,  0.        ],
      [ 0.38754845,  1.        ,  0.        ],
      [ 0.        ,  1.        ,  0.04939015],
  ...
  def test_two_colors_sqrt(self):
    self.result = [
      ...
      [ 0.        ,  1.        ,  1.        ]]
    self.assertSpreadResult([1, 1, 0], [0, 1, 1], 6,
                            transform=Transform.inverse(Transform.SQUARE))
  ...
  def test_inverse_square(self):
    ...
    self.assertSpreadResult([1, 1, 0], [0, 1, 1],
                            6, transform=Transform.inverse(Transform.SQUARE))
  def test_exp(self):
    self.result = [
      [ 1.        ,  1.        ,  0.        ],
      [ 0.54311082,  1.        ,  0.        ],
  ...
  def test_inverse_exp(self):
    self.result = [
      ...
      [ 0.        ,  1.        ,  0.53901822],
      [ 0.        ,  1.        ,  1.        ]]
    self.assertSpreadResult([1, 1, 0], [0, 1, 1], 6, transform=Transform.inverse(Transform.EXP))
  ...
  def test_inverse_sine(self):
    self.result = [
      ...
      [ 0.        ,  1.        ,  1.        ]]
    self.assertSpreadResult([1, 1, 0], [0, 1, 1], 6,
                            transform=Transform.inverse(Transform.SINE))
